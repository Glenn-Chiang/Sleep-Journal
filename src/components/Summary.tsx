...
export const Summary = ({ entries }: SummaryProps) => {
  ...
  const averageSleepDuration = convertDurationToHoursAndMinutes(sleepDurations.reduce((sum, value) => sum + value, 0) / sleepDurations.length)

  return (
    <section className="flex flex-col gap-4 w-full">
      <h1 >Your Sleep Summary</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-slate-500 bg-white rounded-xl p-4 w-full">
